...
public class Health : MonoBehaviour
{
	...
	[SerializeField] ParticleSystem		_particlesToEmitDamage2;
	[SerializeField] int				_onDamageEmission2;
	[SerializeField] ParticleSystem		_particlesToEmitDeath;
	[SerializeField] int				_onDeathEmission;
	[SerializeField] ParticleSystem		_particlesToEmitDeath2;
	[SerializeField] int				_onDeathEmission2;
